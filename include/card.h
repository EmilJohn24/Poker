...
class Card {
	public:
		...
		class InvalidCardException : public std::runtime_exception; //TODO: implement exception
		//constructors
		Card() = default;
		...
		//validity
		static bool isValidNumber(card_num number) { return (number >= 2 number <= Special::KING) 
														|| number == Special::ACE; };
